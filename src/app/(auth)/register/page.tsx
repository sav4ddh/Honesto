      ...
      <div className='w-full max-w-md'>
        <div className='mb-8 flex items-center justify-center space-x-4'>
          ...
          <div className=''>
            ...
            <p className='text-[#BDBDBD]'>Join our anonymous community</p>
          </div>
        </div>
          ...
          <div>
            <div className='relative'>
              <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
                <User className='text-[#CE93D8]' size={18} />
              </div>
              <input
                type='text'
                name='username'
                placeholder='Username'
                className={`w-full pl-10 pr-4 py-3 rounded-lg bg-[#2D1B5E] text-white placeholder-[#BDBDBD] focus:outline-none focus:ring-2 focus:ring-[#9C27B0]'
                }`}
              />
            </div>
          </div>
